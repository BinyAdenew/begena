...
class Training extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return 
       Scaffold(backgroundColor: Color.fromRGBO(158, 106, 62, 0.906),
           ...
           child: SingleChildScrollView(
             ...
             children: [
                Center(
                 child: Padding(
                   ...
                   child: DefaultTextStyle(
                     style: TextStyle(fontSize: 24, color: Colors.brown.shade900, fontFamily: 'Dire_Dawa',),
                ...
                Padding(
                 ...
                 child: DefaultTextStyle(
                   style: TextStyle(fontSize: 20, color: Colors.brown.shade900, fontFamily: 'Dire_Dawa',),
               ...
               Center(
                ...
                Center(
                 child: Padding(
                   ...
                   child: DefaultTextStyle(
                     style: TextStyle(fontSize: 25, color: Colors.brown.shade900, fontFamily: 'Dire_Dawa',),
                     textAlign: TextAlign.center,
                     child: Text(
                         'Krar'),
                   ),
